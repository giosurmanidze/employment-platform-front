...
<template>
  ...
  >
    <li>
      <RouterLink
        to=""
        class="block py-2 px-3 md:p-0 text-gray-900 bg-orange_red_color rounded md:bg-transparent md:text-blue-700 md:dark:text-blue-500"
        >მთავარი</RouterLink
      >
    </li>
    <li>
